...
## Project Structure
* data: contains the MIT-BIH dataset used for training and testing the models (Data can be found here: https://drive.google.com/file/d/1GTkWPEacrND2lzaT3OdgO_Ak3-HHLonh/view?usp=sharing)
